...
pub const QUEUES_KEY: &str = "jimmy:queues";
...
pub const LIMBO_KEY: &str = "jimmy:limbo";
...
pub const RUNNING_KEY: &str = "jimmy:running";
...
pub const ENDED_KEY: &str = "jimmy:ended";
...
pub const TAG_PREFIX: &str = "jimmy:tag:";

pub const STAT_JOBS_CREATED_KEY: &str = "jimmy:stats:jobs:num_created";
pub const STAT_JOBS_COMPLETED_KEY: &str = "jimmy:stats:jobs:num_completed";
pub const STAT_JOBS_RETRIED_KEY: &str = "jimmy:stats:jobs:num_retried";
pub const STAT_JOBS_FAILED_KEY: &str = "jimmy:stats:jobs:num_failed";
pub const STAT_JOBS_TIMED_OUT_KEY: &str = "jimmy:stats:jobs:num_timed_out";
pub const STAT_JOBS_CANCELLED_KEY: &str = "jimmy:stats:jobs:cancelled";
